...
#### Male/Female population distribution
  ...
  - tooltip: This entry provides the distribution of the population between male and female.
  - year_updated: 2023 est. (found in the 65 years and over row)
  - only_country_page_enabled: F
#### Age distribution
  - url: field/age-structure/
  - value: one string of three categories' percentages 0-14 years, 15-64 years, 65 years and over
  - comparitive_ranking: sort and rank the 15-64 years column
  - category: people and society
  - tooltip: This entry provides the distribution of the population according to age. Information is included by sex and age group as follows: 0-14 years (children), 15-64 years (working age), and 65 years and over (elderly)
...
#### Airports, Number of 
  ...
  - year_updated: most are 2024 est., found in string
  - only_country_page_enabled: F
#### Area, Total
  - url: field/area/
  - value: ("tal: ")[1]
...
#### Budget, Expenditures
  ...
  - comparitive_ranking: sort and rank
  - category: economy
  - tooltip: This entry records total spending on national environmental protection, education, health, public order and safety, and other social services, as well as the amount of additional spending on national defense. About two-thirds of the budget is funded by the sale of oil and natural gas. A series of massive government spending increases in 2011 and 2012 led to the growth of the budget deficit, which peaked at 16% of GDP in 2012. The government has largely scaled back public spending in the face of falling oil prices, but it has not reduced the budget deficit by a significant amount.
  - year_updated: (" (")[0][1:5]
  - only_country_page_enabled: F
#### Capital, Name
  - url: field/capital/
  ...
  - comparitive_ranking: NA
  - category: geography
  - tooltip: the name of the seat of government
  - year_updated: NA
  - only_country_page_enabled: F
#### Capital, Geographic Coordinates
  ...
  - comparitive_ranking: NA
  - category: geography
  - tooltip: the geographic coordinates that define the center of the country
  - year_updated: NA
  - only_country_page_enabled: F
#### Capital, Time Difference
  ...
  - comparitive_ranking: NA
  - category: geography
  - tooltip: the difference between Coordinated Universal Time (UTC) and the time observed in the capital
  - year_updated: NA
  - only_country_page_enabled: F
#### Carbon Dioxide emissions
  ...
  - tooltip: This entry is the total amount of carbon dioxide, measured in metric tons, released by burning fossil fuels in the process of producing and consuming energy.
  - year_updated: .split("(")[1:5]
  - only_country_page_enabled: F
#### Citizenship, By Birth
  - url: field/citizenship/
  - value: ("irth: ")[1]
  - comparitive_ranking: NA
  - category: people and society
  - tooltip: This entry provides information related to the acquisition and exercise of citizenship; it includes four subfields: citizenship by birth describes the acquisition of citizenship based on place of birth, known as Jus soli, regardless of the citizenship of parents.
  - year_updated: NA
...
#### Citizenship, By Descent
  ...
  - comparitive_ranking: NA
  - category: people and society
  - tooltip: This entry provides information related to the acquisition and exercise of citizenship; it includes four subfields: citizenship by descent describes the acquisition of citizenship based on the principle of Jus sanguinis, or by descent, where at least one parent is a citizen of the state and being born within the territorial limits of the state is not required.
  - year_updated: NA
  - only_country_page_enabled: T
#### Citizenship, Dual
  - url: field/citizenship/
  ...
  - comparitive_ranking: NA
  - category: people and society
  - tooltip: This entry provides information related to the acquisition and exercise of citizenship; it includes four subfields: dual citizenship recognizes the voluntary acquisition of citizenship and is enforced by the state, no matter where the person is located.
  - year_updated: NA
  - only_country_page_enabled: T
#### Climate
  - url: field/climate/
  ...
  - comparitive_ranking: NA
  - category: geography
  - tooltip: This entry includes a brief description of typical weather regimes throughout the year.
  - year_updated: NA
  - only_country_page_enabled: F
#### Coastline
  - url: field/coastline/
  ...
  - comparitive_ranking: sort and rank
  - category: geography
  - tooltip: This entry gives the total length of the boundary between the land area (including islands) and the sea.
  - year_updated: NA
  - only_country_page_enabled: F
#### Constitution
  - url: field/constitution/
  - value: ("istory: ")[1]
  - comparitive_ranking: NA
  - category: government
  - tooltip: This entry provides information on a country's constitution and includes two subfields. The history subfield includes the dates of previous constitutions and the main steps and dates in formulating and implementing the latest constitution. For countries with 1-3 previous constitutions, the years are listed; for those with 4-9 previous, the entry is listed as "several previous," and for those with 10 or more, the entry is "many previous." The amendments subfield summarizes the process of amending a country's constitution, including the dates of the amendments and the main steps in the process.
  - year_updated: NA
  - only_country_page_enabled: T
#### Credit Ratings
  - url: field/credit-ratings/
  - value: ("oors rating: ")[1]
  - comparitive_ranking: NA
  - category: economy
  - tooltip: This entry provides the current bond ratings for a country or territory from the three major credit bureau Standard & Poors. The year is the year that the rating was first obtained.
  - year_updated: ("(")[1:5]
  - only_country_page_enabled: F
#### Current Health Expenditure
  - url: field/current-health-expenditure/
  - value: just the string
  - comparitive_ranking: sort and rank
  - category: health
  - tooltip: Current health expenditure (CHE) describes the share of spending on health in each country relative to the size of its economy.
  - year_updated: ("(")[1:5]
  - only_country_page_enabled: T
#### Death Rate
  - url: field/death-rate/
  - value: (" (2023")[1] full, includes (2023 est.)
  - comparitive_ranking: sort and rank
  - category: people and society
  - tooltip: This entry gives the average annual number of deaths during a year per 1,000 population at midyear; also known as crude death rate.
  - year_updated: most 2023 est., check string
  - only_country_page_enabled: F
#### Debt, External
  - url: field/debt-external/
  - value: (" (2023")[1] full, includes (2023 est.)
  - comparitive_ranking: sort and rank
  - category: economy
  - tooltip: This entry gives the total public and private debt owed to nonresidents repayable in internationally accepted currencies, goods, or services. These figures are calculated on an exchange rate basis, i.e., not in purchasing power parity (PPP) terms.
  - year_updated: most 2023 est., check string
  - only_country_page_enabled: F
...
for clue in clues:
  lines = clue.split('\n')
  print(lines)
  category_name = lines[0].strip('#').strip()
  # print(category_name)
  category_data = {}
  for line in lines[1:]:
    print(line)
  ...
  country_name = category_data['tooltip'].split(' gives ')[1].split(' ')[0]
#   if country_name not in countries_data:
#     countries_data[country_name] = {}
#   countries_data[country_name][category_name] = category_data

# json_data = json.dumps(countries_data, indent=2)
